...
> - 준호의 커밋 1위 비결을 알게 되었다
> - 생각보다 자잘한 수정사항이 많아서 시간이 예상보다 오래 걸렸다
> - 재밌는 서비스를 개발하는건 즐거운 일이다... 테스트하면서 많이 웃었다

**조준호:**

> - 게임 개발은 처음이었는데 정말 재밌었습니다.
> - 실시간 인터랙션에서 이런저런 버그가 많이 발생해 고치느라 애먹었고, 특히 LLM이 괜찮은 답을 주도록 프롬프트를 짜는 게 정말 어려웠습니다.
> - 랜덤성을 주기 위해 3가지 선택지를 생성하고 서버 측에서 그중 하나를 무작위로 고르는 로직이 주효했던 게 기억에 남습니다.

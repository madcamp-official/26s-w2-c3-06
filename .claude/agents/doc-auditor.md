...
Scope of "shared docs": `CLAUDE.md`, `README.md`, `PLAN.md`, `.claude/agents/*.md`, root `.gitignore`, and any other repo-wide doc. Not code comments, not PR/commit descriptions.
